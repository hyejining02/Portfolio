...
public class KeystoneLV1Controller : MonoBehaviour
{
    ...
    {
        frontImages = Resources.LoadAll<Sprite>("Level5Images");

        TextAsset jsonFile = Resources.Load<TextAsset>("Level5Names");
