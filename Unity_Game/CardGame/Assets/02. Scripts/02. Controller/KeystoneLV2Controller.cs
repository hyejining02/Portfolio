...
public class KeystoneLV2Controller : MonoBehaviour
{
    ...
    {
        frontImages = Resources.LoadAll<Sprite>("Level6Images");

        TextAsset jsonFile = Resources.Load<TextAsset>("Level6Names");
