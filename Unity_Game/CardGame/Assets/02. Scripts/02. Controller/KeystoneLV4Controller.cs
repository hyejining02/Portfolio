...
public class KeystoneLV4Controller : MonoBehaviour
{
    ...
    {
        frontImages = Resources.LoadAll<Sprite>("Level8Images");

        TextAsset jsonFile = Resources.Load<TextAsset>("Level8Names");
